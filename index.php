...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            // 2020.12.10 - Edit by jgullo - Load variables from PHP Config
            <?php
                if ( defined ( 'REALM' ) ) {
                    if ( !empty( REALM ) ) {
...
<!--
                    <tr>
                        ...
                        <td>
			<input type="text" style="width: 100%; height: 100%" id="txtRealm" value="<?php echo constant("REALM"); ?>" placeholder="<?php echo constant("REALM");?>" />
                        </td>
                    </tr>
-->
                    <tr>
